...
def parse_args():
    ...
    ap.add_argument("--rec_model_dir", required=True, help="Exported inference dir containing inference.pdmodel etc.")
    ap.add_argument("--rec_char_dict_path", required=True, help="Your gothi_dict.txt used in training/export")
...
def main():
    ...
    if args.out_dir:
        ...
        out_dir = Path("runs") / "ppocrv5_pure" / datetime.now().strftime("%Y%m%d_%H%M%S")
